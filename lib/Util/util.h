...
class Util {
    public:
        ...
        static void scanForI2CDevices(I2C *i2c);
        ...
        static bool setBits(uint8_t *data, uint8_t start, uint8_t nrOfBits, uint8_t value);
        static bool setBits(uint16_t *data, uint8_t start, uint8_t nrOfBits, uint16_t value);
